...
Has "`$MakePathProbe=Join-Path `$R 'scripts/verify-v2makepath.ps1'" 'make path probe binding'
...
Has '& powershell.exe -NoProfile -ExecutionPolicy Bypass -File $MakePathProbe' 'make path execution'
...
BeforeLine '& powershell.exe -NoProfile -ExecutionPolicy Bypass -File $MakePathProbe' '& powershell.exe -NoProfile -ExecutionPolicy Bypass -File $Build' 'make path before build'
