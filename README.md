...
flowchart LR
    ...
    subgraph V2["OPT-IN V2 RUNTIME PROOF PIPELINE"]
        ...
        V2OUT --> V2CHECK["/health RESPONSE / QUEUE WRAP CHECK"]
...
- DEADWIRE_V2_RUNTIME.EXE OPENS LOOPBACK, SENDS FOUR /HEALTH METHOD REQUESTS, CHECKS EACH RESPONSE, WRAPS THE QUEUE CURSOR, AND CLOSES CLEANLY
